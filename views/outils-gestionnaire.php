...
<div class="container mx-auto px-6">
    ...
    <div class="max-w-4xl mx-auto space-y-12">
        ...
        <div class="bg-gray-800 rounded-3xl p-8 border border-cyan-500/20 hover:border-cyan-400 transition-colors duration-300">
            <h3 class="text-xl font-bold text-cyan-400 mb-6"><i class="fas fa-ship mr-2"></i> Rechercher une Cargaison par Numéro</h3>
            <div class="space-y-4">
                <div>
                    <label for="search-cargo-code" class="block text-gray-300 font-semibold mb-2">Numéro de Cargaison</label>
                    <input type="text" id="search-cargo-code" name="search-cargo-code" placeholder="Entrez le numéro de cargaison" class="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-cyan-400 focus:outline-none">
                </div>
                <button id="search-cargo-btn" class="w-full py-3 bg-cyan-500 hover:bg-cyan-600 rounded-xl text-white font-semibold transition-colors duration-300 shadow-lg shadow-cyan-500/25"><i class="fas fa-search mr-2"></i> Rechercher Cargaison</button>
                <!-- Placeholder pour le résultat de la recherche de cargaison (normalement géré par JS) -->
                <div class="mt-6 p-4 bg-gray-700 rounded-lg border border-cyan-600/30 hidden" id="cargo-search-result">
                    <h4 class="text-lg font-bold text-cyan-300 mb-3">Cargaison trouvée: <span class="text-white" id="cargo-search-result-code"></span></h4>
                    <p class="text-gray-300"><span class="font-semibold">Type:</span> <span class="text-cyan-400" id="cargo-search-result-type"></span></p>
                    <p class="text-gray-300"><span class="font-semibold">Trajet:</span> <span id="cargo-search-result-route"></span></p>
                    <p class="text-gray-300"><span class="font-semibold">État d'avancement:</span> <span class="text-blue-400" id="cargo-search-result-advancement"></span></p>
                    <p class="text-gray-300"><span class="font-semibold">État global:</span> <span class="text-green-400" id="cargo-search-result-global-status"></span></p>
                    <div class="mt-4 flex flex-wrap gap-3">
                        <button class="px-4 py-2 bg-red-500 hover:bg-red-600 rounded-lg text-white text-sm font-semibold"><i class="fas fa-lock mr-1"></i> Fermer Cargaison</button>
                        <button class="px-4 py-2 bg-green-500 hover:bg-green-600 rounded-lg text-white text-sm font-semibold"><i class="fas fa-unlock-alt mr-1"></i> Rouvrir Cargaison</button>
                        <button class="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded-lg text-white text-sm font-semibold"><i class="fas fa-archive mr-1"></i> Archiver Cargaison</button>
                        <select class="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded-lg text-white text-sm font-semibold focus:outline-none">
                            <option value="">Changer État Avancement</option>
                            <option value="en-attente">En attente</option>
                            <option value="en-cours">En cours</option>
                            <option value="arrive">Arrivé</option>
                            <option value="recupere">Récupéré</option>
